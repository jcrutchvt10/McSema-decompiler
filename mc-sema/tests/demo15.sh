...
${CC} -ggdb -m32 -o demo_test15.o demo_test15.c
...
then
    ...
    ../bin_descend/get_cfg.py -d demo_test15.o -o demo_test15.cfg -s demo15_map.txt --entry-symbol imcdecl imstdcall imfastcall
