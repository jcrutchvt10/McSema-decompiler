...
${CC} -ggdb -m32 -Wl,-e,demo1 -o demo_test1.o demo_test1.c
...
then
    ...
    ../bin_descend/get_cfg.py -d demo_test1.o -o demo_test1.cfg
...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=i686-pc-linux-gnu -i demo_test1.cfg -driver=demo1_entry,_start,raw,return,C -o demo_test1.bc
